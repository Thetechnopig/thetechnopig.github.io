...
const imageBounds = [
  [mapBounds.getNorth() + 100, mapBounds.getWest()], // Adjust latitude and longitude for top-left corner
  [mapBounds.getSouth() - 100, mapBounds.getEast()], // Adjust latitude and longitude for bottom-right corner
];
